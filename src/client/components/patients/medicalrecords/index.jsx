                      ...
                      >
                        <div>
                            <div className="text-right">		
                                <a href="#" className="add-new-btn" data-toggle="modal" onClick={() => this.handleShow("medical_records")} data-target="#add_medical_records_modal">Add Medical Records</a>
                            </div>
                ...
                <div className="card card-table mb-0">
                    <div className="card-body">
                        <div className="table-responsive">
                            ...
                            <Modal size="lg" show={this.state.show=="medical_records"} onHide={this.handleClose}>
                                <Modal.Header closeButton>
                                    <Modal.Title><h5 className="modal-title">Add Medical Records</h5></Modal.Title>
                                </Modal.Header>
                                <Modal.Body>
                                    ...
                                    <div className="modal-body">
                                        ...
                                        <div className="col-12 col-md-6">
                                            ...
                                            <label>Title Name</label>
                                             <input type="text" name="description" className="form-control" placeholder="Enter Title Name" />
                                            </div>
                                        </div>
                                        <div className="col-12 col-md-6">
                                            <div className="form-group">
                                        ...
                                        <div className="col-12">
                                            ...
                                            <input type="text" name="hospital" className="form-control" placeholder="Enter name here.." />
                                            </div>
                                        </div>
                                        </div>
                                        <div className="row">
                                        ...
                                        <div className="col-12">
                                            ...
                                            <input type="text" data-role="tagsinput" className="input-tags form-control" defaultValue="Fever, Fatigue" name="services" id="services" />
                                            </div> 
                                        </div>
                                        </div>
                                        <div className="row">
