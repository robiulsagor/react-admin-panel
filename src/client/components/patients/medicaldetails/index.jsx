...
class MedicalDetails extends Component{
    ...
    render(){
        ...
        <div className="content">
                   ...
                   <div className="row">
                        <div className="col-sm-12">
                            ...
                            <div className="card-header">
                                <h4 className="card-title float-left">Medical details</h4>
                                <a href="#modal_medical_form" className="btn btn-primary float-right" onClick={()=> this.handleShow("medical_details")} data-toggle="modal">Add Details</a>
                            </div>
                                ...
                                <table className="table table-hover table-center mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <td>
                                            ...
                                            <a href="#edit_medical_form" onClick={()=> this.handleShow("medical_details")} className="btn btn-sm bg-info-light" data-toggle="modal">
            ...
            <Modal  show={this.state.show=="medical_details"} onHide={this.handleClose}>
                                <Modal.Header closeButton>
                                    <Modal.Title><h5 className="modal-title">Add new data</h5></Modal.Title>
                                </Modal.Header>
                                <Modal.Body>
