                      ...
                      <div className="card-body pt-2 pb-2 mt-1 mb-1">
                        <div className="row">
                          <div className="col-12 col-md-6 col-lg-4 col-xl-3 patient-graph-box">
                            <a href="#" className="graph-box" data-toggle="modal" data-target="#graph1">
                              <div>
                                <h4>BMI Status</h4>
                              </div>
                          ...
                          <div className="col-12 col-md-6 col-lg-4 col-xl-3 patient-graph-box">
                            <a href="#" className="graph-box pink-graph" data-toggle="modal" data-target="#graph2">
                              <div>
                          ...
                          <div className="col-12 col-md-6 col-lg-4 col-xl-3 patient-graph-box">
                            <a href="#" className="graph-box sky-blue-graph" data-toggle="modal" data-target="#graph3">
                              <div>
                                <h4>FBC Status</h4>
                              </div>
                              <div className="graph-img">
                          ...
                          <div className="col-12 col-md-6 col-lg-4 col-xl-3 patient-graph-box">
                            <a href="#" className="graph-box orange-graph" data-toggle="modal" data-target="#graph4">
                              <div>
                                <h4>Weight Status</h4>
                              </div>
                              <div className="graph-img">
