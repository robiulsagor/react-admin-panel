...
import {
  ...
  DoctorThumb07, DoctorThumb08, DoctorThumb09, DoctorThumb10
} from './image'
                    ...
                    <div className="col">
                      <ul className="nav nav-tabs nav-tabs-solid">
                        <li className="nav-item">
                          <Link className="nav-link active" to="/admin/blog">Active Blog</Link>
                        </li>
                        <li className="nav-item">
                          <Link className="nav-link" to="/admin/pending-blog">Pending Blog</Link>
                        </li>
                      </ul>
                    </div>
                    <div className="col-auto">
                      <Link className="btn btn-primary btn-sm" to="/admin/add-blog"><i className="fas fa-plus mr-1" /> Add Blog</Link>
                    </div>
                  </div>
                  {/* Blog */}
                    ...
                    <div className="col-md-6 col-xl-4 col-sm-12">
                      ...
                      <div className="blog grid-blog">
                          ...
                          <ul className="entry-meta meta-item">
                            <li>
                              <div className="post-author">
                                <Link to="/admin/profile"><img src={DoctorThumb01} alt="Post Author" /> <span>Dr. Ruby Perrin</span></Link>
                              </div>
                            </li>
                        ...
                        <div className="row pt-3">
                          <div className="col"><Link to="/admin/edit-blog" className="text-success"><i className="far fa-edit" /> Edit</Link></div>
                          <div className="col text-right" onClick={() =>  handleShow('add')}><a href="" className="text-danger" data-toggle="modal" data-target="#deleteNotConfirmModal"><i className="far fa-trash-alt" /> Inactive</a></div>
                        </div>
                      </div>
                      {/* /Blog Post */}
                    </div>
                      ...
                      <div className="blog grid-blog">
                        ...
                        <div className="blog-content">
                          <ul className="entry-meta meta-item">
                            <li>
                              <div className="post-author">
                                <Link to="/admin/profile"><img src={DoctorThumb02} alt="Post Author" /> <span>Dr. Darren Elder</span></Link>
                              </div>
                            </li>
                      ...
                      <div className="blog grid-blog">
                        ...
                        <div className="blog-content">
                          <ul className="entry-meta meta-item">
                            <li>
                              <div className="post-author">
                                <Link to="/admin/profile"><img src={DoctorThumb03} alt="Post Author" /> <span>Dr. Deborah Angel</span></Link>
                              </div>
                            </li>
                            <li><i className="far fa-clock" /> 3 Dec 2019</li>
                          </ul>
                      ...
                      <div className="blog grid-blog">
                        ...
                        <div className="blog-content">
                          <ul className="entry-meta meta-item">
                            <li>
                              <div className="post-author">
                                <Link to="/admin/profile"><img src={DoctorThumb04} alt="Post Author" /> <span>Dr. Sofia Brient</span></Link>
                              </div>
                            </li>
                      ...
                      <div className="blog grid-blog">
                        ...
                        <div className="blog-content">
                          <ul className="entry-meta meta-item">
                            <li>
                              <div className="post-author">
                                <Link to="/admin/profile"><img src={DoctorThumb05} alt="Post Author" /> <span>Dr. Marvin Campbell</span></Link>
                              </div>
                            </li>
                      ...
                      <div className="blog grid-blog">
                        ...
                        <div className="blog-content">
                          <ul className="entry-meta meta-item">
                            <li>
                              <div className="post-author">
                                <Link to="/admin/profile"><img src={DoctorThumb06} alt="Post Author" /> <span>Dr. Katharine Berthold</span></Link>
                              </div>
                            </li>
                      ...
                      <div className="blog grid-blog">
                        ...
                        <div className="blog-content">
                          <ul className="entry-meta meta-item">
                            <li>
                              <div className="post-author">
                                <Link to="/admin/profile"><img src={DoctorThumb07} alt="Post Author" /> <span>Dr. Linda Tobin</span></Link>
                              </div>
                            </li>
                      ...
                      <div className="blog grid-blog">
                        ...
                        <div className="blog-content">
                          <ul className="entry-meta meta-item">
                            <li>
                              <div className="post-author">
                                <Link to="/admin/profile"><img src={DoctorThumb08} alt="Post Author" /> <span>Dr. Paul Richard </span></Link>
                              </div>
                            </li>
                      ...
                      <div className="blog grid-blog">
                        ...
                        <div className="blog-content">
                          <ul className="entry-meta meta-item">
                            <li>
                              <div className="post-author">
                                <Link to="/admin/profile"><img src={DoctorThumb09} alt="Post Author" /> <span>Dr. John Gibbs</span></Link>
                              </div>
                            </li>
                      ...
                      <div className="blog grid-blog">
                        ...
                        <div className="blog-content">
                          <ul className="entry-meta meta-item">
                            <li>
                              <div className="post-author">
                                <Link to="/admin/profile"><img src={DoctorThumb10} alt="Post Author" /> <span>Dr. Olga Barlow</span></Link>
                              </div>
                            </li>
